...
setwd("C:/Users/Albert Doughan/Desktop/My Project/R Datasets/Star/")
dir = "C:/Users/Albert Doughan/Desktop/My Project/R Datasets/Star/"

# Import metadata
metadatah = read.csv(file= "metadata.csv", header=T, sep = ",")
metadatah = as.data.frame(metadatah)
head(metadatah)

# Reading counts data from featureCounts
counts = read.csv(file = "star_count.csv", header = T, sep = ",")
head(counts)
...
write.csv(as.data.frame(res_sig), "star_deseq_project.csv")
...
# Write final list to file
write.csv(as.data.frame(sig_deg), "star_edger_project.csv")
...
# Write final list to file
write.csv(as.data.frame(order_res), "star_limma_project.csv")




## All STAR common
des1 = read.csv("star_deseq_project.csv", header = T)
head(des1)  
edg1 = read.csv("star_edger_project.csv", header = T)
head(edg1)
lim1 = read.csv("star_limma_project.csv", header = T)
head(lim1)

inter1 = intersect(intersect(des1$X, edg1$X), lim1$X)
length(inter1)
write.csv(inter1, "star_common_project.csv")
