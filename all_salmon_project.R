...
setwd("C:/Users/Albert Doughan/Desktop/My Project/R Datasets/Salmon/")
dir = "C:/Users/Albert Doughan/Desktop/My Project/R Datasets/Salmon/"
...
write.csv(as.data.frame(res_sig), "salmon_deseq_project.csv")
...
# Write final list to file
write.csv(as.data.frame(sig_deg), "salmon_edger_project.csv")
...
# Write final list to file
write.csv(as.data.frame(order_res), "salmon_limma_project.csv")




## All SALMON common
des1 = read.csv("salmon_deseq_project.csv", header = T)
head(des1)  
edg1 = read.csv("salmon_edger_project.csv", header = T)
head(edg1)
lim1 = read.csv("salmon_limma_project.csv", header = T)
head(lim1)

inter1 = intersect(intersect(des1$X, edg1$X), lim1$X)
length(inter1)
write.csv(inter1, "salmon_common_project.csv")
