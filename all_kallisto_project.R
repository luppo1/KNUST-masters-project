...
setwd("C:/Users/Albert Doughan/Desktop/My Project/R Datasets/Kallisto/")
dir = "C:/Users/Albert Doughan/Desktop/My Project/R Datasets/Kallisto/"
...
write.csv(as.data.frame(res_sig), "kallisto_deseq_project.csv")
...
# Write final list to file
write.csv(as.data.frame(sig_deg), "kallisto_edger_project.csv")
...
# Write final list to file
write.csv(as.data.frame(order_res), "kallisto_limma_project.csv")
...
## All KALLISTO common
des1 = read.csv("kallisto_deseq_project.csv", header = T)
head(des1)  
edg1 = read.csv("kallisto_edger_project.csv", header = T)
head(edg1)
lim1 = read.csv("kallisto_limma_project.csv", header = T)
head(lim1)

inter1 = intersect(intersect(des1$X, edg1$X), lim1$X)
length(inter1)

write.csv(inter1, "kallisto_common_project.csv")
